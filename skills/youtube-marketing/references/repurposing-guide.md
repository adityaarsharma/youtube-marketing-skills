...
## Why Repurpose (The Math)

One 10-minute tutorial = 7 platform assets with ~3 hours of additional reach.

HubSpot, 2024: Content repurposed to 3+ formats gets 3.5x total reach vs. single-channel publishing.

| Asset | Platform | Time to create | Estimated reach |
|-------|----------|---------------|----------------|
| Short clip (30–60s) | YouTube Shorts | 30 min edit | 2–10x video views |
| Companion blog post | WordPress | 45 min | Google organic traffic |
| LinkedIn post | LinkedIn | 15 min | 500–5,000 professionals |
| X thread | X (Twitter) | 20 min | 200–2,000 developers |
| Email newsletter | Email list | 20 min | 35–45% open rate |
| Community post | YouTube | 5 min | Browse impression boost |
...
### X (Twitter)
- Thread format: 6–7 tweets
- Tweet 1: surprising result or stat ("This nav menu took 6 minutes, zero CSS")
...
- LinkedIn Algorithm Update, 2025
- Mailchimp Email Benchmark Report, 2025
- BrightEdge Search Intelligence Report, 2025
- YouTube Official Shorts update, September 2025
